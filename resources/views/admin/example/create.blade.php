                    ...
                    @endif
                      ...
                      {{ method_field($method) }}
                        ...
                        <div class="form-group">
													...
													<div class="col-md-8">
														<input type="text" class="form-control" name="example_name" value="{{ old('example_name') }}" placeholder="มินนะ โนะ นิฮงโกะ みんなの日本語 かんじ N5+N4">
													</div>
												</div>
                        ...
                        <div class="form-group">
													...
													<div class="col-md-8">
                            <textarea class="form-control" name="example_detail" rows="4">{{ old('example_detail') }}</textarea>
													</div>
												</div>
